...
import 'package:dargon2_core/src/utils/salt.dart';
...
/// File Name: dargon2_web.dart

class DArgon2Web extends DArgon2 {

  factory DArgon2Web._() => DArgon2Web();

  DArgon2Web() : super.web();
